# Shopeasy Marketing Dashboard Project
...
- Customer Journey Table: Track customer movements through the website to
analyze the conversion funnel.
- Engagement Data Table: Measure engagement with different types of content.
- Customer Reviews Table: Analyze customer feedback to identify common themes
and sentiment
